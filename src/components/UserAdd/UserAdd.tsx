...
export class UserAdd extends React.PureComponent<P & WithStyles<Styles>, S>{
  public static Display = withStyles(styles as any)(UserAdd) as React.ComponentType<P>    //Methode de lecture
